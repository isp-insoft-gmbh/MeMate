...
public class Login extends JFrame {
	...
	loginButton.addActionListener(__ -> {
		...
		LoginInformation login = new LoginInformation(usernameTextField.getText(),
	...
	registerHyperLink.addMouseListener(new MouseAdapter() {
		...
		JButton reg_registrationButton = MeMateUIManager.createButton("button", "Registrieren");
		JButton reg_abortButton = MeMateUIManager.createButton("button", "Abbrechen");
		...
		reg_registrationButton.addActionListener(new ActionListener() {
		    @Override
		    public void actionPerformed(ActionEvent e) {
			boolean isPasswordOrUserNameIncorrect = reg_passwordField.getPassword() == null
			...
			if (isPasswordOrUserNameIncorrect) {
			    ...
			    int reply = JOptionPane.showConfirmDialog(registrationFrame,
				...
				LoginInformation login = new LoginInformation(reg_usernameTextField.getText(),
	...
	if (loginResult == LoginResult.LOGIN_SUCCESSFULL) {
	    ...
	    JButton savePasswordButton = MeMateUIManager.createButton("button", "Speichern");
	    JButton pass_abortButton = MeMateUIManager.createButton("button", "Abbrechen");
		...
		@Override
		public void actionPerformed(ActionEvent e) {
		    boolean isPasswordOrUserNameIncorrect = passwordField.getPassword() == null
			...
			int reply = JOptionPane.showConfirmDialog(changePasswordFrame,
	...
	if (stayLoggedInCheckBox.isSelected()) {
	    try {
		File file = new File(System.getenv("APPDATA") + File.separator + "MeMate" + File.separator
	...
	Color appColor = UIManager.getColor("AppColor");
	String htmlAppColor = "rgb(" + appColor.getRed() + ", " + appColor.getGreen() + ", " + appColor.getBlue() + ")";
